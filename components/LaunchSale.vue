...
<template>
  <section class=" flex justify-center">
    <v-card variant="elevated" class=" max-w-3xl  ">
      <v-card-item>
        <div
          ...
          <div class="justify-center lg:flex lg:items-center" style="grid-area: discount">
            <h3 class="-tracking-wide font-bold text-5xl uppercase whitespace-nowrap lg:text-6xl">
              50% Off*
            </h3>
          </div>
          <div class="flex lg:flex lg:items-center" style="grid-area: sale">
            <span class="-tracking-wide font-semibold text-2xl uppercase lg:text-center">Early Adopter Launch
              Promo!</span>
          </div>
